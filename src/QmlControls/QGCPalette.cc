...
void QGCPalette::_buildMap() {
    ...
    // Cores alteradas para os padrões do skycleanapp
    ...
    // Toolbar Background atualizado para os valores opacos do skycleanapp
    DECLARE_QGC_COLOR(toolbarBackground, "#ffffff", "#ffffff", "#222222", "#222222")

    DECLARE_QGC_COLOR(mainColor, "#1C1C28", "#1C1C28", "#FFFFFF", "#FFFFFF")
    DECLARE_QGC_COLOR(textColor, "#000000", "#000000", "#ffffff", "#ffffff")
    DECLARE_QGC_COLOR(iconColor, "#FFFFFF", "#FFFFFF", "#1C1C28", "#1C1C28")
    ...
    DECLARE_QGC_SINGLE_COLOR(cleanColor, "#6acce0")
