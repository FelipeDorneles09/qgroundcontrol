...
class QGCPalette : public QObject {
   ...
   public:
    ...
    DEFINE_QGC_COLOR(mainColor, setMainColor)
    DEFINE_QGC_COLOR(textColor, setTextColor)
    DEFINE_QGC_COLOR(iconColor, setIconColor)
    DEFINE_QGC_COLOR(borderColor, setBorderColor)
    DEFINE_QGC_COLOR(cleanColor, setCleanColor)
