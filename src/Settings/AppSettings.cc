...
void AppSettings::setLocaleEnglish() { qLocaleLanguage()->setRawValue(static_cast<int>(QLocale::English)); }

void AppSettings::setLocalePortuguese() { qLocaleLanguage()->setRawValue(static_cast<int>(QLocale::Portuguese)); }

bool AppSettings::isLocaleEnglish() {
    return qLocaleLanguage()->rawValue().toInt() == static_cast<int>(QLocale::English);
}

QString AppSettings::missionSavePath(void) { return _childSavePath(missionDirectory); }

QString AppSettings::parameterSavePath(void) { return _childSavePath(parameterDirectory); }

QString AppSettings::telemetrySavePath(void) { return _childSavePath(telemetryDirectory); }

QString AppSettings::logSavePath(void) { return _childSavePath(logDirectory); }

QString AppSettings::videoSavePath(void) { return _childSavePath(videoDirectory); }

QString AppSettings::photoSavePath(void) { return _childSavePath(photoDirectory); }

QString AppSettings::crashSavePath(void) { return _childSavePath(crashDirectory); }

QString AppSettings::mavlinkActionsSavePath(void) { return _childSavePath(mavlinkActionsDirectory); }

QString AppSettings::settingsSavePath(void) { return _childSavePath(settingsDirectory); }
