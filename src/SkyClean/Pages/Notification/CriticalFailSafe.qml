...
Item {
    ...
    property bool _hasFLFMessage20:           false
   ...
   Connections {
        ...
        onNewFormattedMessage: {
            ...
            if (formattedMessage.includes("<FLF:2>")) {
                flfCode = "FLF:2";
            ...
            switch (flfCode) {
                case "FLF:2":
                    _hasFLFMessage20 = true;
                    myAudio.play();
                    console.log("FLF:2 activated, showing specific alert.");
                    break;
                case "FLF:0":
                    _hasFLFMessage20 = false;
                    myAudio.stop();
