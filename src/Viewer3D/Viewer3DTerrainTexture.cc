...
Viewer3DTerrainTexture::Viewer3DTerrainTexture() {
    ...
    // connect(_flightMapSettings->mapProvider(), &Fact::rawValueChanged, this,
    // &Viewer3DTerrainTexture::mapTypeChangedEvent);
...
Viewer3DTerrainTexture::~Viewer3DTerrainTexture() { _terrainTileLoader = nullptr; }
...
void Viewer3DTerrainTexture::loadTexture() {
    ...
    if (_osmParser->mapLoaded()) {
        if (!_terrainTileLoader) {
            ...
            connect(_terrainTileLoader, &MapTileQuery::loadingMapCompleted, this,
                    &Viewer3DTerrainTexture::updateTexture);
            connect(_terrainTileLoader, &MapTileQuery::textureGeometryReady, this,
                    &Viewer3DTerrainTexture::setTextureGeometry);
        }
        _terrainTileLoader->adaptiveMapTilesLoader(_mapType, _mapId, _osmParser->getMapBoundingBoxCoordinate().first,
                                                   _osmParser->getMapBoundingBoxCoordinate().second);
        connect(_terrainTileLoader, &MapTileQuery::mapTileDownloaded, this,
                &Viewer3DTerrainTexture::setTextureDownloadProgress);
    }
}
...
void Viewer3DTerrainTexture::updateTexture() {
    ...
    disconnect(_terrainTileLoader, &MapTileQuery::mapTileDownloaded, this,
               &Viewer3DTerrainTexture::setTextureDownloadProgress);
...
QGeoCoordinate Viewer3DTerrainTexture::roiMinCoordinate() const { return _roiMinCoordinate; }
...
QGeoCoordinate Viewer3DTerrainTexture::roiMaxCoordinate() const { return _roiMaxCoordinate; }
...
bool Viewer3DTerrainTexture::textureLoaded() const { return _textureLoaded; }

OsmParser* Viewer3DTerrainTexture::osmParser() const { return _osmParser; }
...
QSize Viewer3DTerrainTexture::tileCount() const { return _tileCount; }
...
bool Viewer3DTerrainTexture::textureGeometryDone() const { return _textureGeometryDone; }
...
float Viewer3DTerrainTexture::textureDownloadProgress() const { return _textureDownloadProgress; }
